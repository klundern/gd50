...
--[[
    This function is to specifically generate quads for the 10 powerups included in our
    spritesheet (atlas). Fortunately, they are all located in one row (y = 191) and 
    are all the same size (16 x 16 pixels). We then return a table with each powerup,
    indexed 0-9.
]]
