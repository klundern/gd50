...
function LevelMaker.createMap(level)
    ...
    -- determine if this level will have a locked brick (50% chance)
    local LOCKED = math.random(1, 2)
    ...
    --[[ 
        50% chance that this level contains a locked brick; if it does, pick a brick
        at random and make it locked. Set flag to true.
    ]]
    if LOCKED == 1 then
        local location = math.random(1, #bricks)
        local b = bricks[location]
        b.locked = true
        lockedbrick_inPlay = true
    end
