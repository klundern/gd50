...
function love.load()
    ...
    gSounds = {
        ...
        ['powerup_initial'] = love.audio.newSource('sounds/powerup_initial.wav', 'static'),
        ['powerup_triggered'] = love.audio.newSource('sounds/powerup_triggered.wav', 'static'),
        ['upsize'] = love.audio.newSource('sounds/upsize.wav', 'static'),
