    ...
    for k, object in pairs(self.player.level.objects) do
        if object:collides(self.player) then
            if object.solid then
                ...
                -- if the object is a lockblock and it has been hit (which only
                -- can happen if the key has been collected), then remove it from the table
                if object.lockblock and object.hit then
