...
require 'src/states/entity/player/PlayerCarryPotState'
require 'src/states/entity/player/PlayerInteractState'
...
gSounds = {
    ...
    ['heart-drop'] = love.audio.newSource('sounds/heart_drop.wav', 'static'),
    ['heart-pickup'] = love.audio.newSource('sounds/heart_pickup.wav', 'static'),
    ['pot-broken'] = love.audio.newSource('sounds/pot_broken.wav', 'static')
}